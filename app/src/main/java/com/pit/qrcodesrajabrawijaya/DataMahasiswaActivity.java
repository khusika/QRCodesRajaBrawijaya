...
public class DataMahasiswaActivity extends AppCompatActivity {
    ...
    private static final String TAG = DataMahasiswaActivity.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        imageView = (ImageView) findViewById(R.id.dataMahasiswa);
        textView = (TextView) findViewById(R.id.txtHasilData);

        if (CheckPermission(DataMahasiswaActivity.this, Manifest.permission.CAMERA)) {

        } else {
            // you do not have permission go request runtime permissions
            RequestPermission(DataMahasiswaActivity.this, Manifest.permission.CAMERA, REQUEST_RUNTIME_PERMISSION);
        }

        barcodeView = (DecoratedBarcodeView) findViewById(R.id.data_mahasiswa);
        ...
        switch (permsRequestCode) {
            ...
            case REQUEST_RUNTIME_PERMISSION: {
                if (grantResults.length > 0 && grantResults[0] == PackageManager.PERMISSION_GRANTED) {
                    ...
                    AlertDialog alertDialog = new AlertDialog.Builder(DataMahasiswaActivity.this).create();
    ...
    private void kirimData(final String nimnya){
        ...
        final ProgressDialog loadingDialog = new ProgressDialog(DataMahasiswaActivity.this);
